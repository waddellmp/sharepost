        ...
        <div class="row row-grid align-items-center">
          ...
          <div class="col-lg-6 order-lg-1">
            <div class="d-flex px-3">
              ...
              <div class="pl-4">
                <h4 class="display-3 text-white">Post Interface</h4>
      ...
      <div class="col-lg-8">
        <div class="card bg-gradient-secondary shadow">
          <div class="card-body p-lg-5">
            ...
            <button class="btn btn-primary" name="submit" formaction="<?php echo URLROOT;?>/posts/add">Submit</button>
          </form>
          </div>
        </div>
      </div>
