  ...
  <script src="<?php echo URLROOT; ?>/assets/vendor/popper/popper.min.js"></script>
  <script src="<?php echo URLROOT; ?>/assets/vendor/bootstrap/bootstrap.min.js"></script>
  <script src="<?php echo URLROOT; ?>/assets/vendor/headroom/headroom.min.js"></script>
  <!-- Optional JS -->
  <script src="<?php echo URLROOT; ?>/assets/vendor/onscreen/onscreen.min.js"></script>
  <script src="<?php echo URLROOT; ?>/assets/vendor/nouislider/js/nouislider.min.js"></script>
  <script src="<?php echo URLROOT; ?>/assets/vendor/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
  <script src=<?php echo URLROOT; ?>./assets/js/sharepost.js></script>
</body>
  ...
  <hr>
    <div class="container">
      <div class="row row-grid align-items-center my-md">
        <div class="col-lg-6">
          <h3 class="text-primary font-weight-light mb-2">Thank you for checking Sharepost out!</h3>
      ...
      <div class="row align-items-center justify-content-md-between">
        <div class="col-md-6">
          <div class="copyright">
            &copy; 2018
            <a href="https://www.creative-tim.com" target="_blank">Matthew Waddell</a>.
          </div>
        </div>
        <div class="col-md-6">
          <ul class="nav nav-footer justify-content-end">
            <li class="nav-item">
              <a href="https://www.creative-tim.com" class="nav-link" target="_blank">Developer</a>
            </li>
            <li class="nav-item">
